...
import { Heart, Share2, MessageCircle, ChevronRight, Factory, Wrench, Calculator, FileText, Phone, CalendarCheck, Building2, Headphones, Shield, FileSpreadsheet, ClipboardCheck, FolderOpen, TrendingUp, TrendingDown, Minus, Activity, Scale, MapPin, Sun, ChevronLeft, IndianRupee, Image, Eye, Users, UserPlus, CheckCircle2, Store, Star, Gauge, BookOpen } from "lucide-react";
...
function HeroSection({ onNavigate }: { onNavigate: (path: string) => void }) {
  return (
    <div className="relative overflow-hidden rounded-md mx-4 mt-4 mb-6">
      <div className="relative h-56 sm:h-72">
        <img
          src="/images/machine-hero.png"
          alt="Sai Rolotech Industrial Machines"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent" />
        <div className="absolute bottom-0 left-0 right-0 p-5">
          <p className="text-xs font-semibold text-primary-foreground/70 uppercase tracking-widest mb-1" data-testid="text-hero-label">
            Industrial Ecosystem
          </p>
          <h1 className="text-2xl sm:text-3xl font-bold text-white leading-tight mb-2" data-testid="text-hero-title">
            Sai Rolotech
          </h1>
          <p className="text-sm text-white/80 mb-3 max-w-sm" data-testid="text-hero-subtitle">
            Roll Forming Machines, Shutter Patti, POP Channel & More
          </p>
          <div className="flex flex-wrap gap-2 items-center">
            <Button size="sm" onClick={() => onNavigate("/catalog")} data-testid="button-explore-catalog">
              Explore Machines
    ...
    <div className="flex gap-3 px-4 mb-6 overflow-x-auto scrollbar-hide">
      {actions.map((action) => (
        <button
          ...
          className="flex flex-col items-center gap-2 p-3 rounded-md bg-card border border-card-border transition-all min-w-[72px] shrink-0"
        ...
        <div className="px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-primary" data-testid="text-total-visitors">
                {data.total_visits?.toLocaleString("en-IN")}
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div className="text-right">
              ...
              <p className="text-sm font-semibold" data-testid="text-today-visitors">{data.today_visits}</p>
            </div>
          </div>
        </div>
      </Card>
...
function OperatorRegistration() {
  ...
  if (submitted) {
    return (
      <div className="px-4 mb-6">
        <Card className="p-5 border-green-200 dark:border-green-800 bg-green-50/50 dark:bg-green-950/20">
  ...
  return (
    <div className="px-4 mb-6">
      <Card className="p-4" data-testid="card-operator-registration">
        <div className="flex items-center gap-2 mb-3">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              ...
              <select value={form.experience} onChange={e => setForm({...form, experience: e.target.value})} className="w-full h-8 rounded-md border border-input bg-background px-2 text-xs" data-testid="select-op-experience">
          ...
          <div>
            ...
            <select value={form.machineType} onChange={e => setForm({...form, machineType: e.target.value})} className="w-full h-8 rounded-md border border-input bg-background px-2 text-xs" data-testid="select-op-machine">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div>
              ...
              <select value={form.state} onChange={e => setForm({...form, state: e.target.value})} className="w-full h-8 rounded-md border border-input bg-background px-2 text-[10px]" data-testid="select-op-state">
  ...
  return (
    <div className="pb-24">
      ...
      <div className="px-4 mb-3 flex items-center justify-between gap-2">
        ...
        <Badge variant="secondary" className="text-xs" data-testid="badge-post-count">
      ...
      <div className="px-4 py-6 mt-4 border-t text-center">
